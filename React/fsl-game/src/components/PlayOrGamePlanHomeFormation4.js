...
function PlayOrGamePlanHomeFormation4() {
    ...
    return (
        <div>
            <div className='div-t1-gk1-formation4'>
                <div className='div-t1-gk1-obje-formation4'>
                    <div className='div-t1-gk1-information-formation4'>
                        <div className='div-t1-gk1-position-formation4'>
                            {GetHomeTeamGk1_position1()}
                        </div>
                        <div className='div-t1-gk1-rating-formation4'>
                            {GetHomeTeamGk1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-gk1-surname-formation4'>
                        {GetHomeTeamGk1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandGk1()}</span>
                    </div>
                </div>
            </div>
            <div className='div-t1-cbs1-formation4'>
                <div className='div-t1-cb1-formation4'>
                    <div className='div-t1-cb1-obje-formation4'>
                        <div className='div-t1-cb1-information-formation4'>
                            <div className='div-t1-cb1-position-formation4'>
                                {GetHomeTeamCb1_position1()}
                            </div>
                            <div className='div-t1-cb1-rating-formation4'>
                                {GetHomeTeamCb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb1-surname-formation4'>
                            {GetHomeTeamCb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty1-formation4'>
                    <div className='div-t1-dm1-obje-formation4'>
                        <div className='div-t1-dm1-information-formation4'>
                            <div className='div-t1-dm1-position-formation4'>
                                {GetHomeTeamDm1_position1()}
                            </div>
                            <div className='div-t1-dm1-rating-formation4'>
                                {GetHomeTeamDm1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-dm1-surname-formation4'>
                            {GetHomeTeamDm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-cb2-formation4'>
                    <div className='div-t1-cb2-obje-formation4'>
                        <div className='div-t1-cb2-information-formation4'>
                            <div className='div-t1-cb2-position-formation4'>
                                {GetHomeTeamCb2_position1()}
                            </div>
                            <div className='div-t1-cb2-rating-formation4'>
                                {GetHomeTeamCb2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb2-surname-formation4'>
                            {GetHomeTeamCb2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-backs1-formation4'>

            </div>
            <div className='div-t1-dm1-formation4'>
                <div className='div-t1-lb1-formation4'>
                    <div className='div-t1-lb1-obje-formation4'>
                        <div className='div-t1-lb1-information-formation4'>
                            <div className='div-t1-lb1-position-formation4'>
                                {GetHomeTeamLb1_position1()}
                            </div>
                            <div className='div-t1-lb1-rating-formation4'>
                                {GetHomeTeamLb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lb1-surname-formation4'>
                            {GetHomeTeamLb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty2-formation4'>

                </div>
                <div className='div-t1-rb1-formation4'>
                    <div className='div-t1-rb1-obje-formation4'>
                        <div className='div-t1-rb1-information-formation4'>
                            <div className='div-t1-rb1-position-formation4'>
                                {GetHomeTeamRb1_position1()}
                            </div>
                            <div className='div-t1-rb1-rating-formation4'>
                                {GetHomeTeamRb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rb1-surname-formation4'>
                            {GetHomeTeamRb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-cms1-formation4'>
                <div className='div-t1-cm1-formation4'>
                    <div className='div-t1-cm1-obje-formation4'>
                        <div className='div-t1-cm1-information-formation4'>
                            <div className='div-t1-cm1-position-formation4'>
                                {GetHomeTeamCm1_position1()}
                            </div>
                            <div className='div-t1-cm1-rating-formation4'>
                                {GetHomeTeamCm1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm1-surname-formation4'>
                            {GetHomeTeamCm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty3-formation4'>

                </div>
                <div className='div-t1-cm2-formation4'>
                    <div className='div-t1-cm2-obje-formation4'>
                        <div className='div-t1-cm2-information-formation4'>
                            <div className='div-t1-cm2-position-formation4'>
                                {GetHomeTeamCm2_position1()}
                            </div>
                            <div className='div-t1-cm2-rating-formation4'>
                                {GetHomeTeamCm2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm2-surname-formation4'>
                            {GetHomeTeamCm2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-wings1-formation4'>
                <div className='div-t1-lw1-formation4'>
                    <div className='div-t1-lw1-obje-formation4'>
                        <div className='div-t1-lw1-information-formation4'>
                            <div className='div-t1-lw1-position-formation4'>
                                {GetHomeTeamLw1_position1()}
                            </div>
                            <div className='div-t1-lw1-rating-formation4'>
                                {GetHomeTeamLw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lw1-surname-formation4'>
                            {GetHomeTeamLw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty4-formation4'>

                </div>
                <div className='div-t1-rw1-formation4'>
                    <div className='div-t1-rw1-obje-formation4'>
                        <div className='div-t1-rw1-information-formation4'>
                            <div className='div-t1-rw1-position-formation4'>
                                {GetHomeTeamRw1_position1()}
                            </div>
                            <div className='div-t1-rw1-rating-formation4'>
                                {GetHomeTeamRw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rw1-surname-formation4'>
                            {GetHomeTeamRw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-st1-formation4'>
                <div className='div-t1-st1-obje-formation4'>
                    <div className='div-t1-st1-information-formation4'>
                        <div className='div-t1-st1-position-formation4'>
                            {GetHomeTeamSt1_position1()}
                        </div>
                        <div className='div-t1-st1-rating-formation4'>
                            {GetHomeTeamSt1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-st1-surname-formation4'>
...
export default PlayOrGamePlanHomeFormation4;