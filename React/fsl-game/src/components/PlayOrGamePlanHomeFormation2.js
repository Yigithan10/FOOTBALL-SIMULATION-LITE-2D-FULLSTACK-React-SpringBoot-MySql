...
function PlayOrGamePlanHomeFormation2() {
    ...
    return (
        <div>
            <div className='div-t1-gk1-formation2'>
                <div className='div-t1-gk1-obje-formation2'>
                    <div className='div-t1-gk1-information-formation2'>
                        <div className='div-t1-gk1-position-formation2'>
                            {GetHomeTeamGk1_position1()}
                        </div>
                        <div className='div-t1-gk1-rating-formation2'>
                            {GetHomeTeamGk1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-gk1-surname-formation2'>
                        {GetHomeTeamGk1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandGk1()}</span>
                    </div>
                </div>
            </div>
            <div className='div-t1-cbs1-formation2'>
                <div className='div-t1-cb1-formation2'>
                    <div className='div-t1-cb1-obje-formation2'>
                        <div className='div-t1-cb1-information-formation2'>
                            <div className='div-t1-cb1-position-formation2'>
                                {GetHomeTeamCb1_position1()}
                            </div>
                            <div className='div-t1-cb1-rating-formation2'>
                                {GetHomeTeamCb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb1-surname-formation2'>
                            {GetHomeTeamCb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty1-formation2'>

                </div>
                <div className='div-t1-cb2-formation2'>
                    <div className='div-t1-cb2-obje-formation2'>
                        <div className='div-t1-cb2-information-formation2'>
                            <div className='div-t1-cb2-position-formation2'>
                                {GetHomeTeamCb2_position1()}
                            </div>
                            <div className='div-t1-cb2-rating-formation2'>
                                {GetHomeTeamCb2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb2-surname-formation2'>
                            {GetHomeTeamCb2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-backs1-formation2'>
                <div className='div-t1-lb1-formation2'>
                    <div className='div-t1-lb1-obje-formation2'>
                        <div className='div-t1-lb1-information-formation2'>
                            <div className='div-t1-lb1-position-formation2'>
                                {GetHomeTeamLb1_position1()}
                            </div>
                            <div className='div-t1-lb1-rating-formation2'>
                                {GetHomeTeamLb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lb1-surname-formation2'>
                            {GetHomeTeamLb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty2-formation2'>
                    <div className='div-t1-dm1-obje-formation2'>
                        <div className='div-t1-dm1-information-formation2'>
                            <div className='div-t1-dm1-position-formation2'>
                                {GetHomeTeamDm1_position1()}
                            </div>
                            <div className='div-t1-dm1-rating-formation2'>
                                {GetHomeTeamDm1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-dm1-surname-formation2'>
                            {GetHomeTeamDm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-rb1-formation2'>
                    <div className='div-t1-rb1-obje-formation2'>
                        <div className='div-t1-rb1-information-formation2'>
                            <div className='div-t1-rb1-position-formation2'>
                                {GetHomeTeamRb1_position1()}
                            </div>
                            <div className='div-t1-rb1-rating-formation2'>
                                {GetHomeTeamRb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rb1-surname-formation2'>
                            {GetHomeTeamRb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-dm1-formation2'>

            </div>
            <div className='div-t1-cms1-formation2'>
                <div className='div-t1-cm1-formation2'>
                    <div className='div-t1-cm1-obje-formation2'>
                        <div className='div-t1-cm1-information-formation2'>
                            <div className='div-t1-cm1-position-formation2'>
                                {GetHomeTeamCm1_position1()}
                            </div>
                            <div className='div-t1-cm1-rating-formation2'>
                                {GetHomeTeamCm1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm1-surname-formation2'>
                            {GetHomeTeamCm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty3-formation2'>

                </div>
                <div className='div-t1-cm2-formation2'>
                    <div className='div-t1-cm2-obje-formation2'>
                        <div className='div-t1-cm2-information-formation2'>
                            <div className='div-t1-cm2-position-formation2'>
                                {GetHomeTeamCm2_position1()}
                            </div>
                            <div className='div-t1-cm2-rating-formation2'>
                                {GetHomeTeamCm2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm2-surname-formation2'>
                            {GetHomeTeamCm2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-wings1-formation2'>
                <div className='div-t1-lw1-formation2'>
                    <div className='div-t1-lw1-obje-formation2'>
                        <div className='div-t1-lw1-information-formation2'>
                            <div className='div-t1-lw1-position-formation2'>
                                {GetHomeTeamLw1_position1()}
                            </div>
                            <div className='div-t1-lw1-rating-formation2'>
                                {GetHomeTeamLw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lw1-surname-formation2'>
                            {GetHomeTeamLw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty4-formation2'>

                </div>
                <div className='div-t1-rw1-formation2'>
                    <div className='div-t1-rw1-obje-formation2'>
                        <div className='div-t1-rw1-information-formation2'>
                            <div className='div-t1-rw1-position-formation2'>
                                {GetHomeTeamRw1_position1()}
                            </div>
                            <div className='div-t1-rw1-rating-formation2'>
                                {GetHomeTeamRw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rw1-surname-formation2'>
                            {GetHomeTeamRw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-st1-formation2'>
                <div className='div-t1-st1-obje-formation2'>
                    <div className='div-t1-st1-information-formation2'>
                        <div className='div-t1-st1-position-formation2'>
                            {GetHomeTeamSt1_position1()}
                        </div>
                        <div className='div-t1-st1-rating-formation2'>
                            {GetHomeTeamSt1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-st1-surname-formation2'>
...
export default PlayOrGamePlanHomeFormation2;