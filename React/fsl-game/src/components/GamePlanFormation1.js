...
function GamePLanFormation1() {
    ...
    return (
        <div className='div-field-gameplanmenu-formation1'>
            <div className='div-tactics-st00-formation1'>
                <div className='div-tactics-st00-obje-formation1'>
                    <div className='div-tactics-st00-information-formation1'>
                        <div className='div-tactics-st00-position-formation1'>
                            {GetTeamSt00_position1()}
                        </div>
                        <div className='div-tactics-st00-rating-formation1'>
                            {GetTeamSt00_rating()}
                        </div>
                    </div>
                    <div className='div-tactics-st00-surname-formation1'>
                        {GetTeamSt00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandSt00()}</span>
                    </div>
                </div>
            </div>
            <div className='div-tactics-wings-formation1'>
                <div className='div-tactics-lw00-formation1'>
                    <div className='div-tactics-lw00-obje-formation1'>
                        <div className='div-tactics-lw00-information-formation1'>
                            <div className='div-tactics-lw00-position-formation1'>
                                {GetTeamLw00_position1()}
                            </div>
                            <div className='div-tactics-lw00-rating-formation1'>
                                {GetTeamLw00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-lw00-surname-formation1'>
                            {GetTeamLw00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw00()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty4-formation1'>

                </div>
                <div className='div-tactics-rw00-formation1'>
                    <div className='div-tactics-rw00-obje-formation1'>
                        <div className='div-tactics-rw00-information-formation1'>
                            <div className='div-tactics-rw00-position-formation1'>
                                {GetTeamRw00_position1()}
                            </div>
                            <div className='div-tactics-rw00-rating-formation1'>
                                {GetTeamRw00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-rw00-surname-formation1'>
                            {GetTeamRw00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw00()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-cms-formation1'>
                <div className='div-tactics-cm01-formation1'>
                    <div className='div-tactics-cm01-obje-formation1'>
                        <div className='div-tactics-cm01-information-formation1'>
                            <div className='div-tactics-cm01-position-formation1'>
                                {GetTeamCm01_position1()}
                            </div>
                            <div className='div-tactics-cm01-rating-formation1'>
                                {GetTeamCm01_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cm01-surname-formation1'>
                            {GetTeamCm01_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm01()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty3-formation1'>

                </div>
                <div className='div-tactics-cm02-formation1'>
                    <div className='div-tactics-cm02-obje-formation1'>
                        <div className='div-tactics-cm02-information-formation1'>
                            <div className='div-tactics-cm02-position-formation1'>
                                {GetTeamCm02_position1()}
                            </div>
                            <div className='div-tactics-cm02-rating-formation1'>
                                {GetTeamCm02_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cm02-surname-formation1'>
                            {GetTeamCm02_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm02()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-dm00-formation1'>
                <div className='div-tactics-dm00-obje-formation1'>
                    <div className='div-tactics-dm00-information-formation1'>
                        <div className='div-tactics-dm00-position-formation1'>
                            {GetTeamDm00_position1()}
                        </div>
                        <div className='div-tactics-dm00-rating-formation1'>
                            {GetTeamDm00_rating()}
                        </div>
                    </div>
                    <div className='div-tactics-dm00-surname-formation1'>
                        {GetTeamDm00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm00()}</span>
                    </div>
                </div>
            </div>
            <div className='div-tactics-backs-formation1'>
                <div className='div-tactics-lb00-formation1'>
                    <div className='div-tactics-lb00-obje-formation1'>
                        <div className='div-tactics-lb00-information-formation1'>
                            <div className='div-tactics-lb00-position-formation1'>
                                {GetTeamLb00_position1()}
                            </div>
                            <div className='div-tactics-lb00-rating-formation1'>
                                {GetTeamLb00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-lb00-surname-formation1'>
                            {GetTeamLb00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb00()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty2-formation1'>

                </div>
                <div className='div-tactics-rb00-formation1'>
                    <div className='div-tactics-rb00-obje-formation1'>
                        <div className='div-tactics-rb00-information-formation1'>
                            <div className='div-tactics-rb00-position-formation1'>
                                {GetTeamRb00_position1()}
                            </div>
                            <div className='div-tactics-rb00-rating-formation1'>
                                {GetTeamRb00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-rb00-surname-formation1'>
                            {GetTeamRb00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb00()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-cbs-formation1'>
                <div className='div-tactics-cb01-formation1'>
                    <div className='div-tactics-cb01-obje-formation1'>
                        <div className='div-tactics-cb01-information-formation1'>
                            <div className='div-tactics-cb01-position-formation1'>
                                {GetTeamCb01_position1()}
                            </div>
                            <div className='div-tactics-cb01-rating-formation1'>
                                {GetTeamCb01_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cb01-surname-formation1'>
                            {GetTeamCb01_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb01()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty1-formation1'>

                </div>
                <div className='div-tactics-cb02-formation1'>
                    <div className='div-tactics-cb02-obje-formation1'>
                        <div className='div-tactics-cb02-information-formation1'>
                            <div className='div-tactics-cb02-position-formation1'>
                                {GetTeamCb02_position1()}
                            </div>
                            <div className='div-tactics-cb02-rating-formation1'>
                                {GetTeamCb02_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cb02-surname-formation1'>
                            {GetTeamCb02_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb02()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-gk00-formation1'>
                <div className='div-tactics-gk00-obje-formation1'>
                    <div className='div-tactics-gk00-information-formation1'>
                        <div className='div-tactics-gk00-position-formation1'>
                            {GetTeamGk00_position1()}
                        </div>
                        <div className='div-tactics-gk00-rating-formation1'>
                            {GetTeamGk00_rating()}
                        </div>
                    </div>
                    <div className='div-tactics-gk00-surname-formation1'>
...
export default GamePLanFormation1;
