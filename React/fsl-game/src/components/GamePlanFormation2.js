...
function GamePLanFormation2() {
    ...
    return (
        <div className='div-field-gameplanmenu-formation2'>
            <div className='div-tactics-st00-formation2'>
                <div className='div-tactics-st00-obje-formation2'>
                    <div className='div-tactics-st00-information-formation2'>
                        <div className='div-tactics-st00-position-formation2'>
                            {GetTeamSt00_position1()}
                        </div>
                        <div className='div-tactics-st00-rating-formation2'>
                            {GetTeamSt00_rating()}
                        </div>
                    </div>
                    <div className='div-tactics-st00-surname-formation2'>
                        {GetTeamSt00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandSt00()}</span>
                    </div>
                </div>
            </div>
            <div className='div-tactics-wings-formation2'>
                <div className='div-tactics-lw00-formation2'>
                    <div className='div-tactics-lw00-obje-formation2'>
                        <div className='div-tactics-lw00-information-formation2'>
                            <div className='div-tactics-lw00-position-formation2'>
                                {GetTeamLw00_position1()}
                            </div>
                            <div className='div-tactics-lw00-rating-formation2'>
                                {GetTeamLw00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-lw00-surname-formation2'>
                            {GetTeamLw00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw00()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty4-formation2'>

                </div>
                <div className='div-tactics-rw00-formation2'>
                    <div className='div-tactics-rw00-obje-formation2'>
                        <div className='div-tactics-rw00-information-formation2'>
                            <div className='div-tactics-rw00-position-formation2'>
                                {GetTeamRw00_position1()}
                            </div>
                            <div className='div-tactics-rw00-rating-formation2'>
                                {GetTeamRw00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-rw00-surname-formation2'>
                            {GetTeamRw00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw00()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-cms-formation2'>
                <div className='div-tactics-cm01-formation2'>
                    <div className='div-tactics-cm01-obje-formation2'>
                        <div className='div-tactics-cm01-information-formation2'>
                            <div className='div-tactics-cm01-position-formation2'>
                                {GetTeamCm01_position1()}
                            </div>
                            <div className='div-tactics-cm01-rating-formation2'>
                                {GetTeamCm01_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cm01-surname-formation2'>
                            {GetTeamCm01_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm01()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty3-formation2'>

                </div>
                <div className='div-tactics-cm02-formation2'>
                    <div className='div-tactics-cm02-obje-formation2'>
                        <div className='div-tactics-cm02-information-formation2'>
                            <div className='div-tactics-cm02-position-formation2'>
                                {GetTeamCm02_position1()}
                            </div>
                            <div className='div-tactics-cm02-rating-formation2'>
                                {GetTeamCm02_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cm02-surname-formation2'>
                            {GetTeamCm02_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm02()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-dm00-formation2'>
            </div>
            <div className='div-tactics-backs-formation2'>
                <div className='div-tactics-lb00-formation2'>
                    <div className='div-tactics-lb00-obje-formation2'>
                        <div className='div-tactics-lb00-information-formation2'>
                            <div className='div-tactics-lb00-position-formation2'>
                                {GetTeamLb00_position1()}
                            </div>
                            <div className='div-tactics-lb00-rating-formation2'>
                                {GetTeamLb00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-lb00-surname-formation2'>
                            {GetTeamLb00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb00()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty2-formation2'>
                    <div className='div-tactics-dm00-obje-formation2'>
                        <div className='div-tactics-dm00-information-formation2'>
                            <div className='div-tactics-dm00-position-formation2'>
                                {GetTeamDm00_position1()}
                            </div>
                            <div className='div-tactics-dm00-rating-formation2'>
                                {GetTeamDm00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-dm00-surname-formation2'>
                            {GetTeamDm00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm00()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-rb00-formation2'>
                    <div className='div-tactics-rb00-obje-formation2'>
                        <div className='div-tactics-rb00-information-formation2'>
                            <div className='div-tactics-rb00-position-formation2'>
                                {GetTeamRb00_position1()}
                            </div>
                            <div className='div-tactics-rb00-rating-formation2'>
                                {GetTeamRb00_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-rb00-surname-formation2'>
                            {GetTeamRb00_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb00()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-cbs-formation2'>
                <div className='div-tactics-cb01-formation2'>
                    <div className='div-tactics-cb01-obje-formation2'>
                        <div className='div-tactics-cb01-information-formation2'>
                            <div className='div-tactics-cb01-position-formation2'>
                                {GetTeamCb01_position1()}
                            </div>
                            <div className='div-tactics-cb01-rating-formation2'>
                                {GetTeamCb01_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cb01-surname-formation2'>
                            {GetTeamCb01_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb01()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-tactics-empty1-formation2'>

                </div>
                <div className='div-tactics-cb02-formation2'>
                    <div className='div-tactics-cb02-obje-formation2'>
                        <div className='div-tactics-cb02-information-formation2'>
                            <div className='div-tactics-cb02-position-formation2'>
                                {GetTeamCb02_position1()}
                            </div>
                            <div className='div-tactics-cb02-rating-formation2'>
                                {GetTeamCb02_rating()}
                            </div>
                        </div>
                        <div className='div-tactics-cb02-surname-formation2'>
                            {GetTeamCb02_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb02()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-tactics-gk00-formation2'>
                <div className='div-tactics-gk00-obje-formation2'>
                    <div className='div-tactics-gk00-information-formation2'>
                        <div className='div-tactics-gk00-position-formation2'>
                            {GetTeamGk00_position1()}
                        </div>
                        <div className='div-tactics-gk00-rating-formation2'>
                            {GetTeamGk00_rating()}
                        </div>
                    </div>
                    <div className='div-tactics-gk00-surname-formation2'>
...
export default GamePLanFormation2;
