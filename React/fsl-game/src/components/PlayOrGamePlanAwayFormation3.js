...
function PlayOrGamePlanAwayFormation3() {
    ...
    return (
        <div>
            <div className='div-t2-st2-formation3'>
                <div className='div-t2-st2-obje-formation3'>
                    <div className='div-t2-st2-information-formation3'>
                        <div className='div-t2-st2-position-formation3'>
                            {GetAwayTeamSt2_position1()}
                        </div>
                        <div className='div-t2-st2-rating-formation3'>
                            {GetAwayTeamSt2_rating()}
                        </div>
                    </div>
                    <div className='div-t2-st2-surname-formation3'>
                        {GetAwayTeamSt2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandSt2()}</span>
                    </div>
                </div>
            </div>
            <div className='div-t2-wings2-formation3'>
                <div className='div-t2-rw2-formation3'>
                    <div className='div-t2-rw2-obje-formation3'>
                        <div className='div-t2-rw2-information-formation3'>
                            <div className='div-t2-rw2-position-formation3'>
                                {GetAwayTeamRw2_position1()}
                            </div>
                            <div className='div-t2-rw2-rating-formation3'>
                                {GetAwayTeamRw2_rating()}
                            </div>
                        </div>
                        <div className='div-t2-rw2-surname-formation3'>
                            {GetAwayTeamRw2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw2()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t2-empty4-formation3'>

                </div>
                <div className='div-t2-lw2-formation3'>
                    <div className='div-t2-lw2-obje-formation3'>
                        <div className='div-t2-lw2-information-formation3'>
                            <div className='div-t2-lw2-position-formation3'>
                                {GetAwayTeamLw2_position1()}
                            </div>
                            <div className='div-t2-lw2-rating-formation3'>
                                {GetAwayTeamLw2_rating()}
                            </div>
                        </div>
                        <div className='div-t2-lw2-surname-formation3'>
                            {GetAwayTeamLw2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t2-cms2-formation3'>
                <div className='div-t2-cm3-formation3'>
                    <div className='div-t2-cm3-obje-formation3'>
                        <div className='div-t2-cm3-information-formation3'>
                            <div className='div-t2-cm3-position-formation3'>
                                {GetAwayTeamCm3_position1()}
                            </div>
                            <div className='div-t2-cm3-rating-formation3'>
                                {GetAwayTeamCm3_rating()}
                            </div>
                        </div>
                        <div className='div-t2-cm3-surname-formation3'>
                            {GetAwayTeamCm3_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm3()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t2-empty3-formation3'>

                </div>
                <div className='div-t2-cm4-formation3'>
                    <div className='div-t2-cm4-obje-formation3'>
                        <div className='div-t2-cm4-information-formation3'>
                            <div className='div-t2-cm4-position-formation3'>
                                {GetAwayTeamCm4_position1()}
                            </div>
                            <div className='div-t2-cm4-rating-formation3'>
                                {GetAwayTeamCm4_rating()}
                            </div>
                        </div>
                        <div className='div-t2-cm4-surname-formation3'>
                            {GetAwayTeamCm4_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm4()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t2-dm2-formation3'>

            </div>
            <div className='div-t2-backs2-formation3'>
                <div className='div-t2-rb2-formation3'>
                    <div className='div-t2-rb2-obje-formation3'>
                        <div className='div-t2-rb2-information-formation3'>
                            <div className='div-t2-rb2-position-formation3'>
                                {GetAwayTeamRb2_position1()}
                            </div>
                            <div className='div-t2-rb2-rating-formation3'>
                                {GetAwayTeamRb2_rating()}
                            </div>
                        </div>
                        <div className='div-t2-rb2-surname-formation3'>
                            {GetAwayTeamRb2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb2()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t2-empty2-formation3'>

                </div>
                <div className='div-t2-lb2-formation3'>
                    <div className='div-t2-lb2-obje-formation3'>
                        <div className='div-t2-lb2-information-formation3'>
                            <div className='div-t2-lb2-position-formation3'>
                                {GetAwayTeamLb2_position1()}
                            </div>
                            <div className='div-t2-lb2-rating-formation3'>
                                {GetAwayTeamLb2_rating()}
                            </div>
                        </div>
                        <div className='div-t2-lb2-surname-formation3'>
                            {GetAwayTeamLb2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t2-cbs2-formation3'>
                <div className='div-t2-cb3-formation3'>
                    <div className='div-t2-cb3-obje-formation3'>
                        <div className='div-t2-cb3-information-formation3'>
                            <div className='div-t2-cb3-position-formation3'>
                                {GetAwayTeamCb3_position1()}
                            </div>
                            <div className='div-t2-cb3-rating-formation3'>
                                {GetAwayTeamCb3_rating()}
                            </div>
                        </div>
                        <div className='div-t2-cb3-surname-formation3'>
                            {GetAwayTeamCb3_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb3()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t2-empty1-formation3'>
                    <div className='div-t2-dm2-obje-formation3'>
                        <div className='div-t2-dm2-information-formation3'>
                            <div className='div-t2-dm2-position-formation3'>
                                {GetAwayTeamDm2_position1()}
                            </div>
                            <div className='div-t2-dm2-rating-formation3'>
                                {GetAwayTeamDm2_rating()}
                            </div>
                        </div>
                        <div className='div-t2-dm2-surname-formation3'>
                            {GetAwayTeamDm2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm2()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t2-cb4-formation3'>
                    <div className='div-t2-cb4-obje-formation3'>
                        <div className='div-t2-cb4-information-formation3'>
                            <div className='div-t2-cb4-position-formation3'>
                                {GetAwayTeamCb4_position1()}
                            </div>
                            <div className='div-t2-cb4-rating-formation3'>
                                {GetAwayTeamCb4_rating()}
                            </div>
                        </div>
                        <div className='div-t2-cb4-surname-formation3'>
                            {GetAwayTeamCb4_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb4()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t2-gk2-formation3'>
                <div className='div-t2-gk2-obje-formation3'>
                    <div className='div-t2-gk2-information-formation3'>
                        <div className='div-t2-gk2-position-formation3'>
                            {GetAwayTeamGk2_position1()}
                        </div>
                        <div className='div-t2-gk2-rating-formation3'>
                            {GetAwayTeamGk2_rating()}
                        </div>
                    </div>
                    <div className='div-t2-gk2-surname-formation3'>
...
export default PlayOrGamePlanAwayFormation3;