...
function PlayOrGamePlanHomeFormation1() {
    ...
    return (
        <div>
            <div className='div-t1-gk1-formation1'>
                <div className='div-t1-gk1-obje-formation1'>
                    <div className='div-t1-gk1-information-formation1'>
                        <div className='div-t1-gk1-position-formation1'>
                            {GetHomeTeamGk1_position1()}
                        </div>
                        <div className='div-t1-gk1-rating-formation1'>
                            {GetHomeTeamGk1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-gk1-surname-formation1'>
                        {GetHomeTeamGk1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandGk1()}</span>
                    </div>
                </div>
            </div>
            <div className='div-t1-cbs1-formation1'>
                <div className='div-t1-cb1-formation1'>
                    <div className='div-t1-cb1-obje-formation1'>
                        <div className='div-t1-cb1-information-formation1'>
                            <div className='div-t1-cb1-position-formation1'>
                                {GetHomeTeamCb1_position1()}
                            </div>
                            <div className='div-t1-cb1-rating-formation1'>
                                {GetHomeTeamCb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb1-surname-formation1'>
                            {GetHomeTeamCb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty1-formation1'>

                </div>
                <div className='div-t1-cb2-formation1'>
                    <div className='div-t1-cb2-obje-formation1'>
                        <div className='div-t1-cb2-information-formation1'>
                            <div className='div-t1-cb2-position-formation1'>
                                {GetHomeTeamCb2_position1()}
                            </div>
                            <div className='div-t1-cb2-rating-formation1'>
                                {GetHomeTeamCb2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cb2-surname-formation1'>
                            {GetHomeTeamCb2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCb2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-backs1-formation1'>
                <div className='div-t1-lb1-formation1'>
                    <div className='div-t1-lb1-obje-formation1'>
                        <div className='div-t1-lb1-information-formation1'>
                            <div className='div-t1-lb1-position-formation1'>
                                {GetHomeTeamLb1_position1()}
                            </div>
                            <div className='div-t1-lb1-rating-formation1'>
                                {GetHomeTeamLb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lb1-surname-formation1'>
                            {GetHomeTeamLb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLb1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty2-formation1'>

                </div>
                <div className='div-t1-rb1-formation1'>
                    <div className='div-t1-rb1-obje-formation1'>
                        <div className='div-t1-rb1-information-formation1'>
                            <div className='div-t1-rb1-position-formation1'>
                                {GetHomeTeamRb1_position1()}
                            </div>
                            <div className='div-t1-rb1-rating-formation1'>
                                {GetHomeTeamRb1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rb1-surname-formation1'>
                            {GetHomeTeamRb1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRb1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-dm1-formation1'>
                <div className='div-t1-dm1-obje-formation1'>
                    <div className='div-t1-dm1-information-formation1'>
                        <div className='div-t1-dm1-position-formation1'>
                            {GetHomeTeamDm1_position1()}
                        </div>
                        <div className='div-t1-dm1-rating-formation1'>
                            {GetHomeTeamDm1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-dm1-surname-formation1'>
                        {GetHomeTeamDm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandDm1()}</span>
                    </div>
                </div>
            </div>
            <div className='div-t1-cms1-formation1'>
                <div className='div-t1-cm1-formation1'>
                    <div className='div-t1-cm1-obje-formation1'>
                        <div className='div-t1-cm1-information-formation1'>
                            <div className='div-t1-cm1-position-formation1'>
                                {GetHomeTeamCm1_position1()}
                            </div>
                            <div className='div-t1-cm1-rating-formation1'>
                                {GetHomeTeamCm1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm1-surname-formation1'>
                            {GetHomeTeamCm1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty3-formation1'>

                </div>
                <div className='div-t1-cm2-formation1'>
                    <div className='div-t1-cm2-obje-formation1'>
                        <div className='div-t1-cm2-information-formation1'>
                            <div className='div-t1-cm2-position-formation1'>
                                {GetHomeTeamCm2_position1()}
                            </div>
                            <div className='div-t1-cm2-rating-formation1'>
                                {GetHomeTeamCm2_rating()}
                            </div>
                        </div>
                        <div className='div-t1-cm2-surname-formation1'>
                            {GetHomeTeamCm2_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandCm2()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-wings1-formation1'>
                <div className='div-t1-lw1-formation1'>
                    <div className='div-t1-lw1-obje-formation1'>
                        <div className='div-t1-lw1-information-formation1'>
                            <div className='div-t1-lw1-position-formation1'>
                                {GetHomeTeamLw1_position1()}
                            </div>
                            <div className='div-t1-lw1-rating-formation1'>
                                {GetHomeTeamLw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-lw1-surname-formation1'>
                            {GetHomeTeamLw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandLw1()}</span>
                        </div>
                    </div>
                </div>
                <div className='div-t1-empty4-formation1'>

                </div>
                <div className='div-t1-rw1-formation1'>
                    <div className='div-t1-rw1-obje-formation1'>
                        <div className='div-t1-rw1-information-formation1'>
                            <div className='div-t1-rw1-position-formation1'>
                                {GetHomeTeamRw1_position1()}
                            </div>
                            <div className='div-t1-rw1-rating-formation1'>
                                {GetHomeTeamRw1_rating()}
                            </div>
                        </div>
                        <div className='div-t1-rw1-surname-formation1'>
                            {GetHomeTeamRw1_surname()}<span className='div-captainband-allbands'>{ControlCaptainBandRw1()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className='div-t1-st1-formation1'>
                <div className='div-t1-st1-obje-formation1'>
                    <div className='div-t1-st1-information-formation1'>
                        <div className='div-t1-st1-position-formation1'>
                            {GetHomeTeamSt1_position1()}
                        </div>
                        <div className='div-t1-st1-rating-formation1'>
                            {GetHomeTeamSt1_rating()}
                        </div>
                    </div>
                    <div className='div-t1-st1-surname-formation1'>
...
export default PlayOrGamePlanHomeFormation1;